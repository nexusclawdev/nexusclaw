...
export default function SkillHistoryPanel({
  ...
  return (
    <div aria-label="Skill History Panel" className={`skill-history-panel flex h-full min-h-[360px] flex-col rounded-xl border border-slate-700/60 bg-slate-900/60 ${className}`}>
      <div className="flex items-center justify-between gap-2 border-b border-slate-700/60 px-3 py-2.5">
        <div className="flex items-center gap-1">
          <button
            type="button"
            onClick={() => setTab("history")}
            className={`rounded-md px-2 py-1 text-[11px] font-medium transition-all ${tab === "history"
          ...
          <button
            ...
            className={`rounded-md px-2 py-1 text-[11px] font-medium transition-all ${tab === "available"
                ? "bg-slate-700 text-white"
                : "text-slate-400 hover:bg-slate-800/80 hover:text-slate-200"
              }`}
          >
      ...
      <div className="flex items-center gap-1 overflow-x-auto px-3 py-2">
        <button
          ...
          className={`rounded-md border px-2 py-1 text-[10px] transition-all ${providerFilter === "all"
        ...
        {activeProviders.map((provider) => (
          <button
            ...
            className={`rounded-md border px-2 py-1 text-[10px] transition-all ${providerFilter === provider
                ? "border-blue-500/50 bg-blue-600/20 text-blue-300"
                : "border-slate-700 text-slate-400 hover:bg-slate-800/80 hover:text-slate-200"
              }`}
          >
                ...
                <div className="flex shrink-0 items-center gap-2">
                  {canUnlearn && (
                    <button
                      ...
                      className={`skill-unlearn-btn rounded-md border px-1.5 py-0.5 text-[10px] transition-all ${isUnlearning
